	...
	var ProfileInfo = function (_React$Component) {
	  ...
	  _createClass(ProfileInfo, [{
	    ...
	    value: function componentWillMount() {
	      console.log(this);
	      this.props.dispatch((0, _AuthActions.getProfile)(this.props.auth.user));
	    }
	  }, {
	    key: 'render',
