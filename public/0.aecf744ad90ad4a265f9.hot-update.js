	...
	var Registration = function (_React$Component) {
	  ...
	  _createClass(Registration, [{
	    ...
	    value: function render() {
	      ...
	      }), this.state.errors.email && _react2.default.createElement('div', null, _react2.default.createElement('span', null, this.state.errors.email)), _react2.default.createElement('input', { className: 'btn .btn-primary', type: 'submit', value: 'register' })));
	    }
	  }, {
	    key: '_onChange',
