	...
	var ProfileInfo = function (_React$Component) {
	  ...
	  _createClass(ProfileInfo, [{
	    ...
	    value: function componentWillMount() {
	      console.log(this);
	      this.props.dispatch((0, _AuthActions2.default)(this.props.user));
	    }
	  }, {
	    key: 'render',
